...
from ymir.mace_tf_env import (FragmentBuilderEnv, 
                            BatchEnv)
...
from ymir.mace_tf_policy import Agent
...
logging.basicConfig(filename='train_tf.log', 
                    encoding='utf-8', 
                    level=logging.INFO,
...
experiment_name = f"ymir_tf_{timestamp}"
...
state_dict = torch.load('/home/bb596/hdd/ymir/models/ymir_tf_13_02_2024_23_36_19_1500.pt')
