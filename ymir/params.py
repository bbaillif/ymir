...
N_HIDDEN_EQUI_FEATURES = N_HIDDEN_INV_FEATURES
...
N_IRREPS_FRAGMENT = 8
IRREPS_FRAGMENTS = o3.Irreps(f'{N_IRREPS_FRAGMENT}x0e + {N_IRREPS_FRAGMENT}x1o + {N_IRREPS_FRAGMENT}x2e + {N_IRREPS_FRAGMENT}x3o')
